...
const Nav = (props) => {
  ...
  return (
    <nav id='nav-comp' className=' h-15 max-w-mobile md:max-w-none md:h-25 py-7 px-10 flex justify-between items-center text-blueish-50' >
      ...
      <div className='md:hidden'>
        ...
        {isMenuOpen && (
          <ul className='flex top-full left-0 mt-2 rounded-md shadow-lg'>
