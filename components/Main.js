...
const Main = () => {
    ...
    const showProject = projectData.map((p, i) => {
       return(
             <section key={i} id='p1' className='border-t border-blueish-50 md:m-zero-auto md:mb-23 h-117 md:h-61 md:w-224 py-6 md:py-12 grid grid-cols-2  md:grid-cols-3 md:grid-flow-col max-w-mobile md:max-w-none '>
     ...
     return (
        <>
            <Header/>
            <main id='projects' name='projects' className='my-info bg-peach-50 pb-10 max-w-mobile md:max-w-none'>
