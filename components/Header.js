...
const Header = () => {
    return (
        <header id="about" name='about' className=' bg-blueish-50 object-cover flex flex-col py-10 px-0 md:max-w-none md:h-96 md:w-screen  md:grid grid-row-3 md:col-3 md:grid-flow-col '>
            ...
            <h2 id="about-name" className=' pt-10 md:pt-0 pb-4 md:pb-0 leading-10 w-82 md:w-128 md:col-start-2 md:col-end-3 font-bold text-3xl text-peach-50 self-center md:justify-self-start md:self-end '>Hi, my name is Dan, a Software Engineer</h2>
